...
public class VentanaGestionProfesor extends JPanel {
...
//		gridBagLayout.rowWeights = new double[]{Double.MIN_VALUE};
		...
		JLabel lblNewLabel_8 = new JLabel("Gestion de Profesores");
	...
	private void guardar() {
		...
		prof.setNombre(this.jtfnombre.getText());
		prof.setApellido1(this.jtfape1.getText());
		prof.setApellido2(this.jtfape2.getText());
		prof.setDni(this.jtfdni.getText());
